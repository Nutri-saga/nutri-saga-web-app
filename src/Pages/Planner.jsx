    ...
    <div style={{ display: "flex" }}>
      ...
      <DivContainer>
        {data &&  show ? (
          ...
          >
            <CloseIcon onClick={()=>setShow(prev=>!prev)} sx={{position:"absolute", color:"white", cursor:"pointer"}}/>
            <Typography align="center" sx={{color:"white", marginBottom:"3px", letterSpacing:"0.05em",}}>Weekly Nurition Need</Typography>
            <Typography sx={{color:"white"}}>{`Energy : ${data.Energy}g | Protein: ${data.Protein}g | Fats: ${data.Fats}g | Calories: ${data.Calories}g`}</Typography>
          </Card>
        ) : ""}
        <Box
          sx={{
